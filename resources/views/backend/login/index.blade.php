...
<head>
    ...
    <title>Dcms 管理中心 | Dcms Admin Log In</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="javascript:void(0);"><b>Dcms Admin Login</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Dcms 管理中心</p>
...
<!-- iCheck -->
<script src="{{ asset('./backend/adminlte/plugins/iCheck/icheck.min.js') }}"></script>
<script>
    $(function () {
        $('input').iCheck({
